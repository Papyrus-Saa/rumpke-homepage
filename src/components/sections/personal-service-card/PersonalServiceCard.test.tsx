...
jest.mock('next/image', () => ({
  __esModule: true,
  default: (props: { src: string; alt: string; className?: string; loading?: 'eager' | 'lazy'; sizes?: string; fill?: boolean }) => {
...
jest.mock('@/components/ui/title/Title', () => {
  return function MockTitle({ children, ...rest }: { children: React.ReactNode }) {
