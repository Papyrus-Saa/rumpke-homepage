  ...
  return (
    <section className="mx-auto">
      ...
      <div className="text-center mt-8">
        ...
        <Link href="/kontakt" className="inline-block mt-3 px-6 py-2 bg-primary text-white rounded-lg font-semibold shadow hover:bg-primary-dark transition">Kontakt aufnehmen</Link>
      </div>
    </section>
  );
}
