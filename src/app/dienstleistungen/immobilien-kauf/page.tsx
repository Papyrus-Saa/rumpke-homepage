  ...
  return (
    <section className="mx-auto">
      ...
      <div className="bg-primary/10 dark:bg-primary/20 rounded p-6 mb-8">
        ...
        <Link href="/kontakt" className="inline-block mt-3 px-6 py-2 bg-primary text-white rounded-lg font-semibold shadow hover:bg-primary-dark transition">Jetzt Beratung anfragen</Link>
      </div>
    </section>
  );
}
